...
public class ChooseFaultSolutionController implements Initializable {
    @FXML
    ...
    @FXML
    protected void GoToFeatures() throws IOException {
        Stage current_stage = (Stage) cb_faults.getScene().getWindow();
        Parent home_page = FXMLLoader.load(getClass().getResource("set-features-values.fxml"));
